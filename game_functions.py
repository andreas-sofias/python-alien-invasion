...
def fire_bullet(ai_settings,screen,ship,bullets):
    laser = pygame.mixer.Sound("music_and_sfx/laser_gun.mp3")
...
def check_bullet_alien_collisions(ai_settings,screen,sb,stats,ship,aliens,bullets):
    explosion_sfx = pygame.mixer.Sound("music_and_sfx/explosion.mp3")
...
def check_aliens_bottom(ai_settings,stat,sb,screen,ship,aliens,bullets): 
    screen_rect = screen.get_rect()
    for alien in aliens.sprites(): 
        if alien.rect.bottom >= screen_rect.bottom: 
            ship_hit(ai_settings,stat,sb,screen,ship,aliens,bullets)
            break
